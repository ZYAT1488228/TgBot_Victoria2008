...
def stage_1_3(message: types.Message):
    ...
    bot.send_message(
        chat_id=message.chat.id,
        text="Введіть ким та коли виданий паспорт (наприклад, Ізмаїльським МВГУМВС України в Одеській обл., 18.08.2008):",
        reply_markup=markup
    )
    bot.register_next_step_handler_by_chat_id(
        chat_id=message.chat.id,
...
def stage_1_4(message: types.Message):
    ...
    bot.send_message(
        chat_id=message.chat.id,
        text="Введіть ідентифікаційний номер:",
        reply_markup=markup
    )
    bot.register_next_step_handler_by_chat_id(
        chat_id=message.chat.id,
...
def get_pass(message: types.Message):
    ...
    file, name = make_pass(        
        ...
        passport_issued_by=users[message.chat.id].get('passport_issued_by', ''),
